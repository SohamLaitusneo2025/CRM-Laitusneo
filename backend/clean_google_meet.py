...
class CleanGoogleMeet:
    def __init__(self):
        self.base_url = "https://meet.google.com"
        
    def create_clean_meeting(self, meeting_data):
        """
        Create a clean Google Meet meeting
        """
        try:
            ...
            print(f"✅ Clean Google Meet meeting created: {meeting_link}")
            return meeting_info
            
        except Exception as e:
            print(f"❌ Error creating clean meeting: {e}")
...
clean_google_meet = CleanGoogleMeet()
